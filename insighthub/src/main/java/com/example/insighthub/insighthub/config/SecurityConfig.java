package com.example.insighthub.insighthub.config;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            .csrf(csrf -> csrf.disable())   // Necesario para multipart/form-data desde React
            .cors(Customizer.withDefaults()) // Usa el bean corsConfigurationSource()
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/**").permitAll() // Permitir TODOS tus endpoints API
